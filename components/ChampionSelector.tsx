...
export default function ChampionSelector({ label, value, onChange, champions }: Props) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        {selected ? (
          <>
            ...
            <X
              className="ml-auto w-4 h-4 text-gray-500 hover:text-gray-300"
      ...
      {open && (
        <div className="absolute z-50 w-full mt-1 bg-dark-700 border border-gray-700 rounded-xl shadow-2xl overflow-hidden">
          <div className="p-2 border-b border-gray-700">
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-dark-800 border border-gray-600 rounded-lg pl-9 pr-3 py-2 text-sm text-gray-100 placeholder:text-gray-500 focus:outline-none focus:ring-1 focus:ring-gold-400"
              />
            </div>
          </div>
            ...
            {filtered.length === 0 ? (
              ...
              filtered.map((c) => (
                <li key={c.id}>
                  ...
                  >
                    <Image src={c.imageUrl} alt={c.name} width={28} height={28} className="rounded-full" />
